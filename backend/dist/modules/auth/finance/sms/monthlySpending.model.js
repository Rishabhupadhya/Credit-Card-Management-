...
exports.MonthlySpending = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const MonthlySpendingSchema = new mongoose_1.Schema({
    userId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
    creditCardId: { type: mongoose_1.Schema.Types.ObjectId, ref: "CreditCard", required: true, index: true },
    month: {
        type: String,
        required: true,
...
exports.MonthlySpending = mongoose_1.default.model("MonthlySpending", MonthlySpendingSchema);
